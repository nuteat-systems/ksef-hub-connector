...
- `DbCommandRequest.database_name` — Hub may override the SQL catalog per request (shared connector, per-tenant WAPRO databases). Empty value keeps local Mag/Fakir settings.
- Session guard: sticky SQL sessions reject catalog changes mid-session.
...
[1.1.0]: https://github.com/nuteat-systems/ksef-hub-connector/releases/tag/v1.1.0
